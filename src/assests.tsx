...
export const royal_logo=require('./Assests/login_img.webp')
...
export const thankyouimage = require('./Assests/thankyou.webp');
export const warningimage = require('./Assests/warning.webp');

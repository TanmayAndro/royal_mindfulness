...
const Login= () => {
  const [data,setData]=useState({email:"",emailError:false,password:"",passwordError:false,emailErrorMessage:''})
...
<Box style={{width:'100%',height:'1px',backgroundColor:"#CBD5E1",marginBlock:"20px"}}>
          ...
          <InputField placeholder={config.placeHolderEmail}
            error={data.emailError}

            variant="outlined" data-test-id="emailtest"
             value={data.email}
             onChange={(e: any) => {
          ...
          <Typography style={{
            ...
            {config.haveAccount}
            {" "}
            <Link to="/register" style={{ ...AllStyle.boldStyle, cursor: "pointer",
lineHeight: "24px",
textDecoration:'none'

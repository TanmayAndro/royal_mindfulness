 ...
 const [loading, setLoading] = useState(false); // Loader state
  ...
  try {
    const response = await axios.post(
      "https://be-royal-mindfulness.onrender.com/" + loginApi,
      data
    );
                  ...
                  <Box>
                    <GoogleLogin
                      onSuccess={(credentialResponse: any) => {
                        ...
                        console.log("PPPPPPPPPPPPPPPPPPP", credentialResponseDecode);
                        ...
                        //   "https://your-backend-api.com/google-login", // change this to your backend URL
                        //   updatedData
                        // );
